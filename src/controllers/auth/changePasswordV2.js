...
async function changeCurrentPasswordV2(req, res, next) {
    try {
        const { user, userIpAddress, body: { currentPassword, newPassword, confirmNewPassword, deviceId } } = req;
...
export default changeCurrentPasswordV2;
