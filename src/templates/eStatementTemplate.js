...
const EstatementTemplate = ({ fullName, balance, initialBalance, totalCashin, totalCashout, email, address, date, data, currency }) => {
      ...
      <div style="padding-bottom: 20px;"  class="class-flexs">
        <div class="account-name">
          ...
          <div style="font-size: 12px; font-family: Aeonik, sans-serif">
            <span style="font-weight: 600; font-family: 'Aeonik-Medium' ;font-size: 10px">Email:</span>
      ...
      <div class="class-table">
        <table style="width: 100%; border-collapse: collapse">
          <thead>
            ...
            "
              >
                Equivalence in local currency ${currency}
              </th>
              <th
              style="
              padding: 12px 24px;
...
export default EstatementTemplate;
