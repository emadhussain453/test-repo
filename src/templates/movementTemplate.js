...
const MovementTemplate = (otp, { fullName, type, transactionName, bankname, accountNumber, tType, amount, localAmount, date, time, exchageRate, receiverUserName, currency }) => {
                                    ...
                                    <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                                      <div class="v-text-align" style="color: #000000; line-height: 140%; text-align: left; word-wrap: break-word;">
                                        <p style="font-size: 14px; line-height: 140%;">
                                          ${tType === "cashin"
                                            ? "We would like to inform you that the next movement in your Stable® account has been recorded."
                                            : ""}
                                        </p>
                                      </div>
                                    </td>
                                ...
                                <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                                  <div class="v-text-align" style="font-size: 12px; line-height: 40%; text-align: left; word-wrap: break-word;">
                                    <p style="line-height: 40%;"><span style="line-height: 5.6px;">
                                      Movement sent to ${receiverUserName}
                                    </span></p>
                                  </div>
                                </td>
                              </tr>` : `<tr>
                              ...
                              <tbody>
                                <tr>
                                  <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                                    ...
                                    <div class="v-text-align" style="font-size: 12px; line-height: 40%; text-align: left; word-wrap: break-word;">
                                      <p style="line-height: 40%;"><strong>Amount: </strong>${formatAmount(localAmount, locale)} COP</p>
                                    </div>
  ...
  <tbody>
    <tr>
      <td style="padding:10px; font-family:arial,helvetica,sans-serif; color: black;" align="left">
        <div class="v-text-align" style="font-size: 12px; line-height: 1.5; text-align: left; word-wrap: break-word; color: black;">
          <p style="margin: 0; word-break: break-word; color: black;">
            <strong>Exchange rate:</strong> 1 SUSD= ${formatAmount(exchageRate, locale)} COP
          </p>
        </div>
      </td>
    </tr>
