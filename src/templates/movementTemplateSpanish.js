...
const MovementTemplateSpanish = (otp, { fullName, type, transactionName, accountNumber, bankname, tType, amount, localAmount, date, time, exchageRate, receiverUserName, currency }) => {
  const locale = locales[currency || "COP"];
      ...
      <tr style="vertical-align: top">
        <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
          <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td align="center" style="background-color: #ffffff;"><![endif]-->
            ...
            <div class="u-row" style="background: linear-gradient(180deg, #EAB67D 19.27%,#FFF7C6  100%);margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;"> 
                            ...
                            <tbody>
                              <tr>
                                <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                                  ...
                                  <h1 class="v-text-align" style="margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-size: 24px; font-weight: 400;">¡Hola ${fullName}!</h1>
                                  ...
                                  <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                                    <div class="v-text-align" style="color: #000000; line-height: 140%; text-align: left; word-wrap: break-word;">
                                      <p style="font-size: 14px; line-height: 140%;">
                                        ${tType === "cashin"
                                          ? "Te informamos que se ha registrado el siguiente movimiento en tu cuenta Stable®."
                                          : ""}
                                      </p>
                                    </div>
                                  </td>
                ...
                <div id="u_row_4" class="u-row" style="margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: transparent;">
                  <div style="border-collapse: collapse;display: table;width: 100%;height: 100%;background-color: transparent;">
                    ...
                    <div id="u_column_5" class="u-col u-col-57p16" style="max-width: 320px;min-width: 342.96px;display: table-cell;vertical-align: top;">
                      <div style="height: 100%;width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                        <!--[if (!mso)&(!IE)]><!-->
                        <div class="v-col-padding v-col-border" style="box-sizing: border-box; height: 100%; padding: 0px 0px 0px 40px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 2px solid #eab67d;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                          <!--<![endif]-->
                              ...
                              <tr>
                                <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                                  ...
                                  <div class="v-text-align" style="font-size: 14px; line-height: 100%; text-align: left; word-wrap: break-word;">
                                    <p style="line-height: 100%;">${type}:</p>
                                  </div>
                              ...
                              <tr>
                                <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                                  <div class="v-text-align" style="font-family: Arvo; font-size: 29px; line-height: 160%; text-align: left; word-wrap: break-word;display:flex;">
                                    <p style="line-height: 160%;"><span style="line-height: 46.4px;" >
                                    $${amount}
                                    </span>
                                  </p>
                          ...
                          ${tType === "cashin" ? "" : `<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                            <tbody>
                            ${transactionName === "P2P" ? `<tr>
                              <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                                <div class="v-text-align" style="font-size: 12px; line-height: 40%; text-align: left; word-wrap: break-word;">
                                  <p style="line-height: 40%;"><span style="line-height: 5.6px;">
                                  movimiento enviado a ${receiverUserName}
                                  </span></p>
                                </div>
                              </td>
                            </tr>` : `<tr>
                              ...
                              <tr>
                                <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                                  ...
                                  <div class="v-text-align" style="font-size: 12px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                    <p style="line-height: 140%;"><strong>Detalles:</strong></p>
                                  </div>
                            ...
                            <tbody>
                              <tr>
                                <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                                  ...
                                  <div class="v-text-align" style="font-size: 12px; line-height: 40%; text-align: left; word-wrap: break-word;">
                                    <p style="line-height: 40%;"><strong>Fecha:</strong> ${date}</p>
                                  </div>
                            ...
                            <tbody>
                              <tr>
                                <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                                  ...
                                  <div class="v-text-align" style="font-size: 12px; line-height: 40%; text-align: left; word-wrap: break-word;">
                                    <p style="line-height: 40%;"><strong>Tiempo:</strong> ${time}</p>
                                  </div>
                            ...
                            <tbody>
                              <tr>
                                <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                                  ...
                                  <div class="v-text-align" style="font-size: 12px; line-height: 40%; text-align: left; word-wrap: break-word;">
                                    <p style="line-height: 40%;"><strong>Monto: </strong>${formatAmount(localAmount, locale)} COP</p>
                                  </div>
                            ...
                            <tbody>
                              <tr>
                                <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                                  ...
                                  <div class="v-text-align" style="font-size: 12px; line-height: 100%; text-align: left; word-wrap: break-word;">
                                    <p style="line-height: 100%;"><strong>Tasa de cambio: </strong>1 SUSD= ${formatAmount(exchageRate, locale)} COP</p>
                                  </div>
                            ...
                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                              ...
                              <div class="v-text-align" style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                  ...
                                  <p style="line-height: 140%;"><span style="line-height: 19.6px;" >
                                    También puedes consultar esta información en tu app Stable®, en el botón de "Transacciones".
<br>
<br>
No olvides que estamos para ti, siempre que lo necesites. Puedes escribirnos a <span style="color: #000000; line-height: 19.6px;"><a style="color: #000000;" target="_blank" href="mailto:ayuda@stable-life.com" rel="noopener">clientes@stable-life.com</a></span>
<br>
<br>
Equipo Stable®
                                  </span>
...
export default MovementTemplateSpanish;
