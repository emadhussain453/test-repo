...
const otpNotificationTemplateSpanish = (otp, { message, fullName }) => {
                        ...
                        <tbody>
                          <tr>
                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                              ...
                              <h1 class="v-text-align" style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-size: 40px; font-weight: 400;">
                              ${otp}
                              </h1>
                            </td>
                          </tr>
...
export default otpNotificationTemplateSpanish;
